...
export default function InsuranceResources() {
  return (
    <div className=" w-[80%] my-20 mx-auto p-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Explore specialty insurance resources + insights</h2>
        <p className="text-sm text-gray-500 mb-4">Stay up-to-date on emerging industry trends and topics</p>
        <a href="#" className="text-blue-500 text-sm font-semibold">VIEW ALL RESOURCES</a>

        <div className="mt-6 space-y-4">
          {resources.map((resource, index) => (
            <Card key={index} className="border border-gray-200 hover:shadow-lg transition-shadow">
              <CardContent className="flex flex-col">
                <span className="text-blue-500 text-xs font-semibold">{resource.date}</span>
