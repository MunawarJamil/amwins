...
const Footer = () => {
  return (
    <section className="w-[1244px] h-[385px] mx-auto ">
      <div className="container mx-auto px-6 py-12 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mt-[50] relative">
              <span className="absolute -z-10 text-8xl font-bold text-gray-100 opacity-60 -left-4 -top-20 mt-8">
                Let's talk
              </span>
            </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-grow">
                  <input
                    ...
                    className="w-full max-w-md py-3 border-b-2 border-gray-300 focus:border-gray-800 outline-none text-gray-600 bg-transparent"
                  />
        ...
        <div className="flex justify-end mt-1 space-x-4">
          <a
            href="#"
            className="w-10 h-10 border border-gray-300 rounded-full flex items-center justify-center hover:border-gray-800 transition-colors"
          >
