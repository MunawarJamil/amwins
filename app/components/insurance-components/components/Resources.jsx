  ...
  return (
    <div className="mt-16 px-4 md:px-8 lg:px-32 max-w-[1500px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-4 md:mt-6">
        <p className="text- md:text-base max-w-md ml-3">
      ...
      {/* Main Content */}
      <div className="flex flex-col lg:flex-row mt-8 md:mt-12 ml-24 relative">
        {/* Grid Content */}
        ...
        {/* Image */}
        <div className="w-full lg:w-auto mt-8 lg:mt-0 lg:ml-20 lg:pb-5">
          <img 
            className="w-full lg:w-[350px] lg:h-[400px] object-cover mx-auto" // Removed 'absolute' and adjusted for relative positioning
