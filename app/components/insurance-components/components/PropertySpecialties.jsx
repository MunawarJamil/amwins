...
const PropertySpecialties = () => {
  return (
    <>
      ...
      <div className="w-[1260px] mx-auto px-4 py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {specialties.map((specialty, index) => (
            <div
              key={index}
              className="border border-blue-500 rounded p-6 flex items-start"
            >
              {/* Icon */}
              <div className="shrink-0 w-6 h-6 mr-4">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  ...
                  className="w-6 h-6"
                >
                  <circle cx="12" cy="12" r="12" fill="#0A0A1A" />
                  <path
                    d="M7 12L10 15L17 8"
                    stroke="white"
                    strokeWidth="2"
      ...
      <div className="w-[1230px] mx-auto px-4 mt-9 border border-blue-500 flex flex-col md:flex-row items-start md:items-center gap-6 py-8">
        {/* Icon + Title */}
        ...
        <div className="md:w-2/3">
          <p className="text-gray-700">
            ...
            fugiat omnis tenetur excepturi dolore nulla esse illum repellat magni
            nam tempore, deserunt nesciunt quaerat! Ab similique est quo
            cupiditate optio!
          </p>
        </div>
      </div>
