...
const CaseStudy = () => {
  return (
    <div className="bg-gradient-to-b from-black to-purple-900 text-white mx-4 md:mx-auto max-w-[1260px] px-6 md:px-12 lg:px-36 py-12 md:py-16 lg:py-20 mt-12 md:mt-24 lg:mt-48 rounded-3xl mb-12 md:mb-24">
