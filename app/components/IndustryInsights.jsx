...
export default function IndustryInsights() {
  ...
  return (<>
    <section className="flex flex-col lg:border shadow-md lg:flex-row lg:w-[1200px] mx-auto items-center    px-6   py-12">
      {/* Left Image Section */}
      ...
      <div className="w-full lg:w-[70%] leading-normal  border   p-5 ">
        ...
        <p className="mt-4 text-gray-600  leading-normal">
          ...
          industry expertise, strong partnerships, and advanced analytics. With
          a global reach and specialized teams, we help you navigate risks and
        ...
        <div className="mt-8 w-[300px] flex items-center gap-4 p-4 bg-white shadow-md rounded-lg">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-blue-600">+01 111-223-43</p>
          </div>
        </div>
      </div>
    </section>
 ...
 <section className="px-6 lg:px-20   mt-10   shadow-lg py-10">
