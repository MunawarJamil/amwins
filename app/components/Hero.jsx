  ...
  return (
    <>
      ...
      <div className="relative header hidden lg:flex justify-center ">
        ...
        <div className="absolute flex top-1/3 pt-10 w-[70%] font-[Asap] mx-auto gap-10 left-[50%] justify-evenly mt-14 text-white transform -translate-x-1/2 -translate-y-1/2">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-1 p-5">
              {/* Stats Grid */}
              <div className="border-l-2 border-sky-400 pl-2">
                <p className="text-2xl font-bold text-sky-400 border-b-2 border-gray-400 pb-2 inline-block">
                  $39B
                </p>
                <p>Annual Premium Allocations</p>
              </div>
            ...
            <div className="absolute bottom-20 left-[-40] font-[Onest] bg-white rounded-lg p-4 shadow-lg max-w-xs">
              <p className=" relative text-sm  flex gap-3  items-center font-semibold text-gray-700">
                ...
                <div className="bg-black w-7 h-7 rounded-md flex items-center justify-center">
                  <img src="/arrow-up.png" alt="arrow" className="  " />
                </div>
              </p>
